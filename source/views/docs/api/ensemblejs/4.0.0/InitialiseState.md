...
The initialise state plugin will get all [`StateSeed`](StateSeed.html) plugins and will execute each one passing their return values into the StateMutator. This will prepare the game state for play. This will happen once per game.
